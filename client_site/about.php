...
<body>
    ...
    <div class="content">
        ...
        <h2>Our Mission</h2>
        <img src="images/about-mission.jpg" alt="Curated vintage clothing collection" class="content-image">
        <p>
        ...
        <img src="images/about-story.jpg" alt="Vintage thrift store finds" class="content-image">
        <p>
        ...
        <div class="about-cta">
            ...
            <button class="cta-button" id="shop-cta">Start Shopping</button>
        </div>
    </div>
